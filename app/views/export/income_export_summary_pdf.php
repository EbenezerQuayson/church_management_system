...
<div class="summary">
    <div class="summary-item">
        <strong>Total Income: </strong>¢<?php echo number_format($total['total'], 2); ?>
  
    </div>
     <div class="summary-item">
        <strong>This Month: </strong>¢<?php echo number_format($monthTotal['total'], 2); ?>
    </div>
</div>
...
<tr>
    <td class="member-name">
        ...
        if ($d['income_source'] === 'service_total') {
            ...
            echo trim($d['first_name'] . ' ' . $d['last_name']);
        } else {
            echo 'Anonymous';
        }
        ?>
    </td>
    <td class="amount">¢<?php echo number_format($d['amount'],2); ?></td>
...
$dompdf->stream('income_summary_' . date('Y-m-d') . '.pdf', ['Attachment' => false]);
